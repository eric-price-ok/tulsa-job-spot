...
def upgrade() -> None:
    # Run the full schema SQL. This is the single source of truth for the
    # initial database structure; subsequent migrations use op.* operations.
    op.execute(sa.text("""
-- =============================================================================
-- FUNCTIONS
-- =============================================================================
...
CREATE TABLE public.company (
    ...
    is_scraped                 bool DEFAULT false NOT NULL,
    created_at                 timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at                 timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
CREATE INDEX idx_joblistings_fts ON public.joblistings
...
def downgrade() -> None:
    op.execute(sa.text("""
DROP VIEW IF EXISTS public.skill_demand CASCADE;
DROP VIEW IF EXISTS public.pending_user_company_roles CASCADE;
DROP VIEW IF EXISTS public.pending_joblistings CASCADE;
DROP VIEW IF EXISTS public.pending_companies CASCADE;
DROP VIEW IF EXISTS public.companyprofile CASCADE;

DROP TABLE IF EXISTS public.joblistingcertifications CASCADE;
DROP TABLE IF EXISTS public.user_certifications CASCADE;
DROP TABLE IF EXISTS public.user_skills CASCADE;
DROP TABLE IF EXISTS public.sitefeatures CASCADE;
DROP TABLE IF EXISTS public.scrapinglog CASCADE;
DROP TABLE IF EXISTS public.notifications CASCADE;
DROP TABLE IF EXISTS public.saved_searches CASCADE;
DROP TABLE IF EXISTS public.saved_jobs CASCADE;
DROP TABLE IF EXISTS public.applications CASCADE;
DROP TABLE IF EXISTS public.joblistingskills CASCADE;
DROP TABLE IF EXISTS public.joblistings CASCADE;
DROP TABLE IF EXISTS public.notes CASCADE;
DROP TABLE IF EXISTS public.companytechnologies CASCADE;
DROP TABLE IF EXISTS public.companyindustries CASCADE;
DROP TABLE IF EXISTS public.companyfunctions CASCADE;
DROP TABLE IF EXISTS public.companybenefits CASCADE;
DROP TABLE IF EXISTS public.company_socials CASCADE;
DROP TABLE IF EXISTS public.companysite CASCADE;
DROP TABLE IF EXISTS public.company_invites CASCADE;
DROP TABLE IF EXISTS public.user_company_roles CASCADE;
DROP TABLE IF EXISTS public.company CASCADE;
DROP TABLE IF EXISTS public.users CASCADE;
DROP TABLE IF EXISTS public.skills CASCADE;
DROP TABLE IF EXISTS public.skill_categories CASCADE;
DROP TABLE IF EXISTS public.certifications CASCADE;
DROP TABLE IF EXISTS public.certification_providers CASCADE;
DROP TABLE IF EXISTS public.social_media_types CASCADE;
DROP TABLE IF EXISTS public.officelocations CASCADE;
DROP TABLE IF EXISTS public.jobtype CASCADE;
DROP TABLE IF EXISTS public.jobstatus CASCADE;
DROP TABLE IF EXISTS public.experience CASCADE;
DROP TABLE IF EXISTS public.industries CASCADE;
DROP TABLE IF EXISTS public.functionspecialties CASCADE;
DROP TABLE IF EXISTS public.functions CASCADE;
DROP TABLE IF EXISTS public.features CASCADE;
DROP TABLE IF EXISTS public.benefits CASCADE;
DROP TABLE IF EXISTS public.companysitetype CASCADE;
DROP TABLE IF EXISTS public.company_type CASCADE;
DROP TABLE IF EXISTS public.cities CASCADE;
DROP TABLE IF EXISTS public.state CASCADE;
DROP TABLE IF EXISTS public.country CASCADE;

DROP FUNCTION IF EXISTS public.update_scraping_duration CASCADE;
